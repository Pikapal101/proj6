...
#add term courses
TermCourse.create([{term: terms[0], course: courses[0]}, {term: terms[0], course: courses[1]}, {term: terms[0], course: courses[2]}, {term: terms[0], course: courses[3]}, {term: terms[0], course: courses[4]}, {term: terms[1], course: courses[5]}, {term: terms[1], course: courses[6]}, {term: terms[1], course: courses[7]}, {term: terms[1], course: courses[8]}, {term: terms[1], course: courses[9]}, {term: terms[2], course: courses[10]}, {term: terms[3], course: courses[11]} ])
